...
from apps.listings.models import Watchlist, Listing
...
class TestWatchlistViewSet:
    ...
    def test_user_cannot_remove_other_users_watchlist_item(self, authenticated_client, another_authenticated_client):
...
class TestWatchlistInListingDetailSerializer:
    ...
    def test_save_count_multiple_users(self, authenticated_client, another_authenticated_client):
